...
def main():
  ...
  parser.add_argument("-fps", help="frame per second", type=float, default=27.729)
  ...
  parser.add_argument("-vw", "--view_width", help="view width", type=int, default=192)
  parser.add_argument("-vh", "--view_height", help="view height", type=int, default=150)
